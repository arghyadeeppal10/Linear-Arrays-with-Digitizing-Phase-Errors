...
plot(x,angles)
grid on
title("5 bit Angle Phase Plot")

sum =0;

bits=5;
A = dec2bin(0:2^bits-1)-'0';
ANG = [11.25,22.5,45,90,180]';
states = A*ANG;
...
legend("5 bit Angle Phase", "Golden Phase")
hold off
...
title("Plot of Radiation Pattern for 5 bit Phase Shifter")
rlim([-30 0])
figure(7)
polarplot(theta,abs(E2bit))
title("Plot of Absolute Value of Electric Field for 5 bit Phase Shifter")
