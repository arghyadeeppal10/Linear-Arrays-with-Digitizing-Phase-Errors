...
legend("2 bit Angle Phase", "Golden Phase")
hold off
...
title("Plot of Radiation Pattern for 2 bit Phase Shifter")
rlim([-30 0])
figure(7)
polarplot(theta,abs(E2bit))
title("Plot of Absolute Value of Electric Field for 2 bit Phase Shifter")
